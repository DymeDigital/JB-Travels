...
const destinations: Destination[] = [
  ...
  },
  {
    ...
    name: "Mauritius",
    country: "Port Louis",
    description: "Escape to crystal-clear waters, white sandy beaches, and unforgettable island experiences.",
    image: "/images/maurit.png",
    longDescription: "Experience the tropical paradise of Mauritius with tailor-made holidays designed for relaxation, adventure, and luxury. Whether you're planning a romantic honeymoon, a family getaway, or a peaceful island retreat, our flexible packages offer breathtaking beaches, world-class resorts, vibrant culture, and unforgettable experiences, all carefully curated to suit your travel style and budget.",
    highlights: [
    ],
  },
  {
    ...
    name: "Egypt",
    country: "Cairo",
    description: "Where ancient history, breathtaking landscapes, and unforgettable cultural experiences come together.",
    image: "/images/egypt.png",
    longDescription: "Experience the magic of Egypt with a journey through one of the world's most fascinating destinations. Explore iconic ancient wonders, cruise along the legendary Nile River, immerse yourself in a rich cultural heritage, and discover vibrant local traditions. From historic landmarks and breathtaking scenery to spiritual sites and authentic Egyptian hospitality, every itinerary offers a memorable blend of history, adventure, and relaxation.",
    highlights: [
